...
$submitted_report_filename = '';

$mysql_query2 = "SELECT * FROM industrial_registration WHERE index_number='$student_index_number' LIMIT 1";
$execute_mysql_query2 = mysqli_query($conn,$mysql_query2);
  
if($row_set = mysqli_fetch_assoc($execute_mysql_query2)){
  $submitted_report_filename = $row_set['submitted_report'];
}else{

$mysql_query4 = "SELECT * FROM vira_registration WHERE index_number='$student_index_number' LIMIT 1";
$execute_mysql_query4 = mysqli_query($conn,$mysql_query4);

if($row_set = mysqli_fetch_assoc($execute_mysql_query4)){
  $submitted_report_filename = $row_set['submitted_report'];
}
  ...
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading phead">
          <h2 class = "panel-title ptitle">Visiting Supervisor Grades</h2>
       </div>
        <div class = "panel-body pbody">
         
          <form method="POST" action="download_submitted_report.php">
              <strong>
               
                  <?php  if($submitted_report_filename != ''): ?>

                    <?php echo $student_full_name ?> has submitted his/her report :
                    <input type="submit" value="<?php echo $submitted_report_filename?>" name="submitted_report_filename" id="view_report" class="btn btn-primary btn-sm" title="Click to download"/>

                  <?php else : ?>
                    <?php echo $student_full_name ?> has not submitted his/her report.
                  <?php endif ?>
