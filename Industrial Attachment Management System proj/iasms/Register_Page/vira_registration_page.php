  ...
  if(isset($_POST["btn_submit"])){
    if($_POST["student_programme"]!="" && $_POST["student_session"]!=""){
      ...
      if($check_user==1){
       ...
       $insert_details_command = "INSERT INTO vira_registration (`id`, `first_name`, `last_name`, `other_name`, `index_number`, `programme`, `session`,`faculty`,`date`) VALUES (NULL,'$student_fname', '$student_lname', '$other_name','$student_index', '$student_programme_selected', '$student_session_selected','$student_faculty', CURRENT_TIMESTAMP)";
