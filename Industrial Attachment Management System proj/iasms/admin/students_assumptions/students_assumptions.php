            ...
            <div class = "panel-body pbody">
              ...
              <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    //   $region_id = $row_set['company_region_id'];
                    //   $mysql_query_command_1 = "SELECT * FROM regions WHERE id = '$region_id'";
                    //   $execute_result_query = mysqli_query($conn,$mysql_query_command_1);
                    //  // $row_set['company_region'] = mysqli_fetch_assoc($execute_result_query)['region_name'];

                    //  var_dump($row_set['company_region_id']);
