...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="../departments/departments.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Departments</li></a>
...
<div id="main_content">
    ...
    <div class = "panel">
        <div class = "panel-heading phead">
                <h2 class = "panel-title ptitle"> Registered Departments</h2>
        </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <?php
                       ...
                       $i = 1;
                       $mysql_query_command = "SELECT * FROM departments";
                       ...
                       while($row_set = mysqli_fetch_assoc($execute_result_query)){
                           ...
                           echo "<tr style='text-align:center;font-size:1.1em'>";
                               ...
                               echo "<td style='width: 80px;'>".$i."</td>";
                               echo "<td>".$row_set['name']."</td>";
                               echo '<td style="width: 200px;">
                                           <form method="post" action="departments_inc.php">
                                               <input type="hidden" name="drop_department_id" value="'.$row_set['id'].'"/>
                                               <input type="submit" value="Drop" name="btn_drop_department" class="btn btn-primary"/>
                                           </form>
                                       </td>';
   ...
   <div class="panel">
        <div class="panel-heading phead phead-adjusted">
            <h2 class = "panel-title ptitle"> Add Department</h2>
        </div>
                ...
                <form method="post" action="departments_inc.php">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" placeholder="Enter Name" name="txt_add_department_name" class="form-control"/>
                            </div>
                            <div class="col-md-5">
                            <input type="submit" value="Add" name="btn_add_department" class="btn btn-primary"/>
                            </div>
