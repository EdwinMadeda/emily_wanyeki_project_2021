...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="change_password.php"><li style="background-color:orange;padding-left:16px" class="menu_items_list">Change Supervisor Password</li></a>
  ...
  <div class="container-fluid">
    <div class = "panel">
       <div class = "panel-heading industrial_phead">
          <h2 class = "panel-title industrial_ptitle"> Change Supervisor Password</h2>
       </div>
