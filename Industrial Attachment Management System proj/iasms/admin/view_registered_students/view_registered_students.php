...
if(isset($_POST["btn_search"])){
  ...
  if($search_by!=""&& $search_term!=""){
    ...
    switch ($search_by) {
      ...
      // echo $mysql_query_2;
      // $execute_query = mysqli_query($conn, $mysql_query_2);

      // echo '<pre>';
      // print_r(mysqli_fetch_assoc($execute_query));
      // echo '</pre>';
              ...
              <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    while ($row_set = mysqli_fetch_array($execute_result_query)){
                      ...
                      echo "<td>
                          <form action='view_registered_students.inc.php' method='POST'>
                            <input type='hidden' value='".$row_set["id"]."' name='drop_vira_registration_student_id'>
                            <input type='submit' class='btn btn-primary' value='drop' name='btn_drop_vira_registration_student' id='btn_drop_vira_registration_student'>
                          </form>
                      </td>";
                    ...
                    while($row_set_2 = mysqli_fetch_array($execute_result_query_2)){
                      ...
                      echo "<td>
                          <form action='view_registered_students.inc.php' method='POST'>
                            <input type='hidden' value='".$row_set_2["id"]."' name='drop_industrial_registration_student_id'>
                            <input type='submit' class='btn btn-primary' value='drop' name='btn_drop_industrial_registration_student' id='btn_drop_industrial_registration_student'>
                          </form>
                      </td>";
