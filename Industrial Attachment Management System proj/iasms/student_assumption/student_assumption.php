...
<div id="main_content">
  <div class="container-fluid">
    <div class = "panel">
     ...
     <div class="form-group">
      ...
      <input type="text" class="form-control form-control-adjusted" id="txt_company_name" placeholder="Enter company name" name="txt_company_name">
    </div>

    <div class="form-group">
     <label for="txt_supervisors_name">Supervisors Name : </label>
     <input type="text" class="form-control form-control-adjusted" id="txt_supervisors_name" placeholder="Enter supervisors name" name="txt_supervisors_name">
   </div>

   <div class="form-group">
    <label for="txt_supervisors_contact">Supervisors Contact : </label>
    <input type="text" maxlength="15" class="form-control form-control-adjusted" id="txt_supervisors_contact" placeholder="Enter supervisors contact" name="txt_supervisors_contact">
  </div>

  <div class="form-group">
   <label for="txt_supervisors_email">Supervisors Email : </label>
   <input type="email" class="form-control form-control-adjusted" id="txt_supervisors_email" placeholder="Enter supervisors e-mail" name="txt_supervisors_email">
 </div>
 ...
 if(isset($_POST["btn_submit"])){
   ...
   if($_POST["txt_company_name"]!="" && $_POST["txt_supervisors_name"]!="" && $_POST["txt_supervisors_contact"]!="" && $_POST["txt_supervisors_email"]!="" && $_POST["selected_region"]!="" && $_POST["txt_address"]!=""){
      ...
      $visiting_supervisor_name = 'unassigned';
      ...
      $my_insert_query = "INSERT INTO `students_assumption` (`id`, `first_name`, `last_name`, `other_name`,`index_number`, `programme`, `session`,`company_name`, `supervisor_name`, `supervisor_contact`,`supervisor_email`, `company_region`, `company_address`,`registration_type`, `date`) VALUES (NULL, '$student_fname',
         '$student_lname', '$student_other_name', '$student_index_number',
         '$student_programme', '$student_session', '$student_company_name', '$student_supervisor_name','$student_supervisor_contact', '$student_supervisor_email','$student_company_region', '$student_company_address','$student_registration_type', CURRENT_TIMESTAMP)";
      ...
      if($run_query = mysqli_query($conn,$my_insert_query)){
          echo "<script>alert('Details Have Been Submitted Successfully')</script>";
			...
			$my_update_query3 = "UPDATE `vira_registration` SET `attachment_region` = '$student_company_region' WHERE index_number = '$student_index_number'";
